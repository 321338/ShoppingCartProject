...
print ("\nYour order is complete please see your receipt :\n")
...
printReceipt = open ("printReceipt.txt","wt")                    
                     
for x in productDictionary:
  if x in order:
    type = productDictionary[x]
    printReceipt.write(str(order[x])+" x "+ str(type[0])+ " =  £"+str(order[x]*int(productDictionary[x][1])/100)+ "\n") 
